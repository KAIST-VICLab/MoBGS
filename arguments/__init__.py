...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.stat_npts = 40000
        self.dyn_npts = 20000
        self.lambda_flow_loss = 1e-2
...
class blceParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.adjoint = False
        self.start_warp = 0
        self.start_warp_dynamic = 0
        self.start_pixel_weight = 300000
        self.start_warp_exposure = 2000
        super().__init__(parser, 'blce Parameters')
